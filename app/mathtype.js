...
window.loadLatexFromWord = function(latex) {
  ...
  showStatus(currentLang === 'km' ? "✓ បានបំប្លែងសមីការពី Word មក MathType រួចរាល់!" : "✓ Equation loaded from Word into MathType!", true);
};
...
function showAboutModal() {
  ...
  title.innerText = "About MathType 7 (Khmer Math Edition)";
  body.innerHTML = `
    <div style="text-align: center; margin-bottom: 16px;">
      <img src="./assets/icons/MT_ICO.png" width="48" height="48" style="margin-bottom: 8px;">
      <h2 style="font-size: 16px; margin: 0; color: #111;">MathType 7.4</h2>
      <p style="font-size: 12px; color: #666; margin: 4px 0 0 0;">64-bit Native C++ / Objective-C Edition (Khmer Math Editor)</p>
    </div>
    <p>MathType 7 Desktop Edition re-engineered for 64-bit macOS systems with deep Microsoft Word AppleScript integration and baseline alignment from Khmer Math Editor.</p>
  ...
  body.innerHTML = `
    <div class="tex-config-container">
      <p style="margin: 0; font-size: 12.5px; color: #475569;">
        ${currentLang === 'km' 
          ? "MathType 7 ប្រើប្រាស់ LaTeX Kernel ដើម្បីបង្កើតសមីការច្បាស់កម្រិត 300 DPI ចូលក្នុង Microsoft Word។ សូមពិនិត្យ ឬកំណត់ទីតាំងថត (Binary Directory) របស់ TeX:"
          : "MathType 7 uses the LaTeX Kernel to generate crystal clear 300 DPI equations into Microsoft Word. Please check or configure your TeX binary directory:"}
      </p>
